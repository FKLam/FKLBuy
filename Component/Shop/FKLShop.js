        ...
        return(
            <View style={styles.navOutViewStyle}>
                <TouchableOpacity activeOpacity={0.5} style={styles.leftViewStyle} onPress={() => {this.props.navigator.pop()}}>
                    <Image source={{uri: 'icon_shop_local'}} style={styles.navImageStyle}></Image>
                </TouchableOpacity>
                <Text style={{color: 'white', fontSize: 22, fontWeight: 'bold', marginTop: 20}}>商家</Text>
                <TouchableOpacity activeOpacity={0.5} style={styles.rightViewStyle}>
                    <Image source={{uri: 'icon_shop_search'}} style={styles.navImageStyle}></Image>
                </TouchableOpacity>
            </View>
        )
    }
